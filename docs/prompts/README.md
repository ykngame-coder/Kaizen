...
| `corriger-programme-luc-leger.md` | **Corriger la transcription du programme « Test Luc Léger »** (donnée utilisateur mal saisie : course/endurance mappée en force/Hyrox) — contenu réel du PDF + structure cible exacte (blocs `tabata`, footing extérieur, navettes) | ⬜ À faire — **prioritaire** |
