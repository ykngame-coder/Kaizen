...
export function MyRecipesScreen(): React.JSX.Element {
  ...
  return (
    <Screen scroll>
      ...
      {logging ? <FoodLogCard food={recipeToFoodItem(logging)} onLogged={() => router.back()} /> : null}
...
export function CommunityRecipesScreen(): React.JSX.Element {
  ...
  return (
    <Screen scroll>
      ...
      {selected ? <FoodLogCard food={recipeToFoodItem(selected)} onLogged={() => router.back()} /> : null}
